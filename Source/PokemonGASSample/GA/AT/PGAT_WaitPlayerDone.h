...
public:
	...
	static UPGAT_WaitPlayerDone* CreateTask(UGameplayAbility* OwningAbility, TArray<class APGPlayerState*> InPlayerStates, FGameplayTag InEventTag);
...
protected:
	TArray<TObjectPtr<class APGPlayerState>> PlayerStates;
